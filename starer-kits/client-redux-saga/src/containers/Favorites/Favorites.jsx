...
class Favorites extends Component {
  ...
  getMovies(isLoadMore) {
    ...
    this.props.onLoadFavoritesMovies(isLoadMore ? pageNumber + 1 : pageNumber);
  }
...
const mapDispatchToProps = (dispatch) => {
  return {
    onLoadFavoritesMovies: (request) => dispatch(favoritesActions.loadFavoritesMovies(request)),
